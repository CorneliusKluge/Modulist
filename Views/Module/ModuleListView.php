        ...
        if($result->num_rows) {
            ...
            ?>
                <tr>
                    ...
                    <!--how to use other tables here (categories and module_category_mm)?
                        or just show total workload?-->
                    <td><?php echo $module["name"];?></td> <!--categories-->
                    <td><?php echo $module["workload"];?></td> <!--module_category_mm-->
                    ...
                    <td>
                        <input type="button" id="module_list_edit" name="module_list_edit"/>
                        <input type="button" id="module_list_delete" name="module_list_delete"/>
